...
include("header.php");
  ...
  if(isset($_POST["submit_add_trans"])){
			...
			<div class="modal-content">
				<form method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<input type="number" name="credit" value=0   class="form-control" hidden>
						</div>	
						<div class="form-group">
						 	<label>Debit</label>
							<input type="number" name="debit" value=0  class="form-control" required >
						</div>	
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
						<input type="submit" name="submit_add_trans" class="btn btn-success" value="Add">
					</div>
				</form>
			</div>
		</div>
